/**********************************************************************
 * a1_height_mode1_native.cpp
 *
 * Unitree A1 High-level height test.
 *
 * Safety rule:
 *   This program NEVER uses mode=2.
 *   It only sends mode=1 with bodyHeight ramp.
 *
 * Usage:
 *   sudo -E ./a1_height_mode1_native
 **********************************************************************/
...
public:
    ...
    void RobotControl()
    {
        ...
        {
            float rate = (motiontime - 1000) / 1500.0f;
        ...
        else if (motiontime < 6000)
        {
            float rate = (motiontime - 4500) / 1500.0f;
        ...
        if (motiontime > 7000)
        {
            std::cout << "[A1_HEIGHT_MODE1_NATIVE] finished" << std::endl;
            exit(0);
        }
    }
