...

{
  ...
  echo "===== map files ====="
  ls -lh /home/unitree/a1_maps || true
  cat /home/unitree/a1_maps/a1_lab.yaml || true
...
roslaunch slam_planner a1_saved_map_teb_logged.launch log_dir:="${LOG_DIR}" 2>&1 | tee "${LOG_DIR}/roslaunch_console.log"
