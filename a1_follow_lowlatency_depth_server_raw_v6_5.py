#!/usr/bin/env python3
"""
Low-latency A1 camera/follow server. RAW-command variant for body safety filter.

Features:
- /snapshot.jpg returns the latest RGB frame only, no MJPEG buffering.
- /follow writes /tmp/a1_follow_cmd_raw; a1_body_safety_filter.py converts it to /tmp/a1_follow_cmd for the driver.
    ...
    def do_GET(self):
        ...
        if path in ("/", "/status"):
            ...
            body = (
                ...
                "raw_cmd=/tmp/a1_follow_cmd_raw\n"
                "filtered_cmd=/tmp/a1_follow_cmd\n"
                "stop=/follow_stop\n"
