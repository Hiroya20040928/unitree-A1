...
Run on NX:
  ...
  python ~/a1_slam_route_fallback_node_v6_4_raw.py _scan_topic:=/scan _odom_topic:=/odom
...
def main():
    rospy.init_node("a1_slam_route_fallback_node_v6_4_raw")
    ...
    rospy.loginfo("a1_slam_route_fallback_node_v6_4_raw started scan=%s odom=%s", scan_topic, odom_topic)
    main_loop()
