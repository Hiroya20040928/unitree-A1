...
def compute_route_cmd(scan, pose, lost_age, lost_dist, last_xerr):
    ...
    max_vx = rospy.get_param("~route_max_vx", 0.055)
    align_vx = rospy.get_param("~route_align_vx", 0.025)
    max_wz = rospy.get_param("~route_max_wz", 0.28)
    k_heading = rospy.get_param("~k_heading", 0.90)
    ...
    k_side_vy = rospy.get_param("~k_side_vy", 0.045)
    k_wall_yaw = rospy.get_param("~k_wall_yaw", 0.05)
    vy_bias = rospy.get_param("~vy_bias", -0.035)
